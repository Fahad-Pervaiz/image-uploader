...
<template>
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
                <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:flex-1">
                    <Link
